...
object Coverage {
  ...
  */
   ...
   *
   * @param coverage The coverage to which to get the histogram.
   * @param scale    The scale to which to resample the coverage before getting the histogram.
   * @return
   */
   ...
   * @param downSampling // Whether to downsample or upsample, default is true
